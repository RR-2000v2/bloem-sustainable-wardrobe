  ...
  return <section id="how-it-works" className="py-20 bg-white">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => <div key={index} className="flex flex-col">
              <div className="relative mb-6">
                ...
                {index < steps.length - 1 && <div className="hidden lg:block absolute top-6 left-12 h-0.5 bg-bloem-lavender w-[calc(100%-3rem)]"></div>}
              </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="md:w-1/2">
              ...
              <ul className="space-y-3">
                {["No need to meet strangers for exchanges", "Available 24/7 in convenient locations", "Items are securely locked until authorized pickup", "Eco-friendly alternative to shipping"].map((point, index) => <li key={index} className="flex items-start">
                ...
                <div className="absolute inset-4 flex items-center justify-center">
                  <div className="w-full h-full bg-gray-200 rounded-2xl flex items-center justify-center">
                    <div className="text-center p-6">
                      ...
                      <img src="https://raw.githubusercontent.com/RR-2000v2/bloem-sustainable-wardrobe/refs/heads/main/public/App%205.jpeg" alt="Homepage" className="w-full h object-center object-scale-down" />
                    </div>
                  </div>
                </div>
              </div>
